...
public class ImageHashBolt extends BaseRichBolt{
	...
	private String image_url = "http://" + MatchpConfig.getMATCHP_SERVICE_IP() + "/image/";
	private HttpPost post ;
	private OutputCollector collector;
	
	private final String imgSign = "imgSign";
		...
		try {
            ...
            if (entity != null) {
            	...
            	if (reply.getCode() == 200) {
					...
					json = JsonUtility.setAttribute(json, imgSign, arrayStr);
